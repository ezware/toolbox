func replaceEasyInstall()
{
    ...
    printf("sudo https_proxy=$https_proxy LANG=C chroot $FILESYSTEM_ROOT /bin/bash -c \"[ ! -d /usr/local/lib/python2.7/dist-packages/setuptools/ ] || find /usr/local/lib/python2.7/dist-packages/setuptools/ -type f -name \\\"*.py\\\" -exec sed -i \\\"s/https:\\\\/\\\\/pypi.python.org/http:\\\\/\\\\/10.153.3.130\\\\/pypi\\\\/web/g;s/https:\\\\/\\\\/pypi.org/http:\\\\/\\\\/10.153.3.130\\\\/pypi\\\\/web/g\\\" {} +\"\n");
    ...
    printf("sudo https_proxy=$https_proxy LANG=C chroot $FILESYSTEM_ROOT /bin/bash -c \"[ ! -d /usr/local/lib/python3.7/dist-packages/setuptools/ ] || find /usr/local/lib/python3.7/dist-packages/setuptools/ -type f -name \\\"*.py\\\" -exec sed -i \\\"s/https:\\\\/\\\\/pypi.python.org/http:\\\\/\\\\/10.153.3.130\\\\/pypi\\\\/web/g;s/https:\\\\/\\\\/pypi.org/http:\\\\/\\\\/10.153.3.130\\\\/pypi\\\\/web/g\\\" {} +\"\n");

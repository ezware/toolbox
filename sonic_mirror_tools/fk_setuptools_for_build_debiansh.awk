func addpipconf()
{
    ...
    {
        printf("sudo https_proxy=$https_proxy LANG=C chroot $FILESYSTEM_ROOT [ ! -d %s ] || find %s -type f -name '*.py' -exec sed -i 's|https://pypi.python.org|http://%s/pypi/web|g;s|https://pypi.org|http://%s/pypi/web|g' {} +\n", 
